...
# # *****************************************
    ...
    # parser.add_argument("--model-file", default="D_model_4layers_baseline_ILIF01_count_to_adaptive_back_count_kernel3_test",
    #                 help="Model module/path; defaults to the value saved in the checkpoint_test")
...
# # *****************************************
    ...
    # parser.add_argument("--model-file", default="C_model_4layers_baseline_ILIF01_count_to_adaptive_back_two_online_noatten_test",
    #                 help="Model module/path; defaults to the value saved in the checkpoint_test")

    # parser.add_argument("--checkpoint", default="/home/wangyufei/code/SNNTransformer/Spikingformer/B_output/train/C_model_4layers_baseline_ILIF01_count_to_adaptive_back_two_online_noatten-20260716-054011/model_best.pth.tar")
...
# # *****************************************
    ...
    # parser.add_argument("--model-file", default="D_model_4layers_baseline_ILIF01_count_to_adaptive_back_count_add_internal_test",
    #                 help="Model module/path; defaults to the value saved in the checkpoint_test")

    # parser.add_argument("--checkpoint", default="/home/wangyufei/code/SNNTransformer/Spikingformer/B_output/train/D_model_4layers_baseline_ILIF01_count_to_adaptive_back_count_add_internal-20260720-061303/model_best.pth.tar")
...
# # *****************************************
    ...
    # parser.add_argument("--model-file", default="D_model_4layers_baseline_ILIF01_count_to_adaptive_back_count_add_internal_kernel3_test",
    #                 help="Model module/path; defaults to the value saved in the checkpoint_test")

    # parser.add_argument("--checkpoint", default="/home/wangyufei/code/SNNTransformer/Spikingformer/B_output/train/D_model_4layers_baseline_ILIF01_count_to_adaptive_back_count_add_internal_kernel3-20260720-144046/model_best.pth.tar")
